...
internal sealed class CoreStringResources
{
    ...
    internal const string Argument_AdjustmentRulesrDaylightSavingTimeOverlap =
        "Argument_AdjustmentRulesrDaylightSavingTimeOverlap";

    internal const string Argument_AdjustmentRulesrDaylightSavingTimeOverlapNonRuleRange =
        "Argument_AdjustmentRulesrDaylightSavingTimeOverlapNonRuleRange";
    ...
    internal const string ArgumentOutOfRange_ImpersonationOptionsInvalid =
    ...
    internal const string ArgumentOutOfRange_HandleInheritabilityNoneOrInheritable =
    ...
    internal const string InvalidOperation_EndWaitForConnectionCalledMultiple =
    ...
    internal const string NotSupported_AnonymousPipeMessagesNotSupported =
    ...
    internal const string ArgumentOutOfRange_NeedMaxFileSizeGEBufferSize =
    ...
    internal const string Perflib_Argument_InvalidCounterSetInstanceType =
    ...
    internal const string Perflib_InsufficientMemory_InstanceCounterBlock =
        "Perflib_InsufficientMemory_InstanceCounterBlock";

    internal const string Perflib_InsufficientMemory_CounterSetTemplate =
    ...
    internal const string Perflib_InvalidOperation_CounterSetNotInstalled =
    ...
    internal const string Perflib_InvalidOperation_AddCounterAfterInstance =
    ...
    internal const string Perflib_InvalidOperation_CounterSetContainsNoCounter =
    ...
    internal const string LockRecursionException_RecursiveReadNotAllowed =
        "LockRecursionException_RecursiveReadNotAllowed";

    internal const string LockRecursionException_RecursiveWriteNotAllowed =
        "LockRecursionException_RecursiveWriteNotAllowed";

    internal const string LockRecursionException_RecursiveUpgradeNotAllowed =
        "LockRecursionException_RecursiveUpgradeNotAllowed";

    internal const string LockRecursionException_ReadAfterWriteNotAllowed =
        "LockRecursionException_ReadAfterWriteNotAllowed";

    internal const string LockRecursionException_WriteAfterReadNotAllowed =
        "LockRecursionException_WriteAfterReadNotAllowed";

    internal const string LockRecursionException_UpgradeAfterReadNotAllowed =
        "LockRecursionException_UpgradeAfterReadNotAllowed";

    internal const string LockRecursionException_UpgradeAfterWriteNotAllowed =
    ...
    internal const string SynchronizationLockException_MisMatchedUpgrade =
        "SynchronizationLockException_MisMatchedUpgrade";

    internal const string SynchronizationLockException_IncorrectDispose =
    ...
    internal const string Cryptography_ArgExpectedECDiffieHellmanCngPublicKey =
    ...
    internal const string Cryptography_ECXmlSerializationFormatRequired =
    ...
    internal const string Cryptography_OpenEphemeralKeyHandleWithoutEphemeralFlag =
    ...
    private static CoreStringResources? coreStringResources;
    ...
    public static string? GetString(string name, params object[] args)
    {
        ...
        var str = loader.resources.GetString(name, Culture);
        ...
        {
            var str1 = args[i] as string;
            if (str1 is { Length: > 1024 })
            {
                args[i] = string.Concat(str1.Substring(0, 1021), "...");
            }
        }

        return string.Format(CultureInfo.CurrentCulture, str ?? string.Empty, args);
    }

    public static string? GetString(string name)
    {
        var stringResources = GetLoader();
        if (stringResources == null)
        {
            return null;
        }

        return stringResources.resources.GetString(name, Culture);
    }

    private static CoreStringResources GetLoader()
    {
        if (coreStringResources != null)
        {
            return coreStringResources;
        }

        var sR = new CoreStringResources();
#pragma warning disable CS8601 // Possible null reference assignment.
#pragma warning disable CS8625 // Cannot convert null literal to non-nullable reference type.
        Net20Interlocked.CompareExchange<CoreStringResources>(ref coreStringResources, sR, null);
