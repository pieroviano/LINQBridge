...
internal class OrderedGroupByGrouping<TGroupKey, TOrderKey, TElement> :
    ...
    IEnumerable
{
    private readonly TGroupKey m_groupKey;
    private readonly IComparer<TOrderKey> m_orderComparer;
    private readonly GrowingArray<TOrderKey> m_orderKeys;
    private readonly GrowingArray<TElement> m_values;
    ...
    {
        var valueCount = m_values.Count;
        var valueArray = m_values.InternalArray;
