...
public static class Queryable
{
        ...
        Expression<Func<TSource, TSource, TSource>> func)
    {
        ...
        return source.Provider.Execute<TSource>(Expression.Call(null, GetMethodInfo(Aggregate, source, func),
            new Expression[2]
            {
                source.Expression,
        ...
        Expression<Func<TAccumulate, TSource, TAccumulate>> func)
    {
        ...
        return source.Provider.Execute<TAccumulate>(Expression.Call(null, GetMethodInfo(Aggregate, source, seed, func),
            new Expression[3]
            {
                source.Expression,
        ...
        Expression<Func<TAccumulate, TResult>> selector)
    {
        ...
        return source.Provider.Execute<TResult>(Expression.Call(null,
            GetMethodInfo(Aggregate, source, seed, func, selector), source.Expression, Expression.Constant(seed),
            Expression.Quote(func), Expression.Quote(selector)));
    }
        ...
        Expression<Func<TSource, bool>> predicate)
    {
        ...
        return source.Provider.Execute<bool>(Expression.Call(null, GetMethodInfo(All, source, predicate),
            new Expression[2]
            {
                source.Expression,
        ...
        Expression<Func<TSource, bool>> predicate)
    {
        ...
        return source.Provider.Execute<bool>(Expression.Call(null, GetMethodInfo(Any, source, predicate),
            new Expression[2]
            {
                source.Expression,
                Expression.Quote(predicate)
    ...
    /// <summary>
    ///     Converts a generic <see cref="T:System.Collections.Generic.IEnumerable`1" /> to a generic
    ///     <see cref="T:System.Linq.IQueryable`1" />.
    /// </summary>
    ...
    ///     <paramref name="source" /> does not implement <see cref="T:System.Collections.Generic.IEnumerable`1" /> for some
    ///     <paramref name="T" />.
    /// </exception>
    /// <exception cref="T:System.ArgumentNullException">
    ///     <paramref name="source" /> is null.
    ...
    public static IQueryable AsQueryable(this IEnumerable source)
    {
        ...
        var genericType = TypeHelper.FindGenericType(typeof(IEnumerable<>), source.GetType());
        return !(genericType == null)
            ? EnumerableQuery.Create(genericType.GetGenericArguments()[0], source)
    ...
    public static double Average(this IQueryable<int> source)
    {
        ...
        return source.Provider.Execute<double>(Expression.Call(null, GetMethodInfo(Average, source),
            source.Expression));
    }
    ...
    public static double? Average(this IQueryable<int?> source)
    {
        ...
        return source.Provider.Execute<double?>(
            Expression.Call(null, GetMethodInfo(Average, source), source.Expression));
    }
    ...
    public static float? Average(this IQueryable<float?> source)
    {
        ...
        return source.Provider.Execute<float?>(Expression.Call(null, GetMethodInfo(Average, source),
            source.Expression));
    }
    ...
    public static decimal? Average(this IQueryable<decimal?> source)
    {
        ...
        return source.Provider.Execute<decimal?>(Expression.Call(null, GetMethodInfo(Average, source),
            source.Expression));
    }

    /// <summary>
    ///     Computes the average of a sequence of <see cref="T:System.Int32" /> values that is obtained by invoking a
        ...
        Expression<Func<TSource, int>> selector)
    {
        ...
        return source.Provider.Execute<double>(Expression.Call(null, GetMethodInfo(Average, source, selector),
            new Expression[2]
            {
                source.Expression,
    ...
    /// <summary>
    ///     Computes the average of a sequence of nullable <see cref="T:System.Int32" /> values that is obtained by
    ///     invoking a projection function on each element of the input sequence.
    /// </summary>
    /// <returns>
    ///     The average of the sequence of values, or null if the <paramref name="source" /> sequence is empty or contains
    ///     only null values.
    /// </returns>
    /// <param name="source">A sequence of values to calculate the average of.</param>
    /// <param name="selector">A projection function to apply to each element.</param>
    ...
    /// <summary>
    ///     Computes the average of a sequence of <see cref="T:System.Single" /> values that is obtained by invoking a
    ///     projection function on each element of the input sequence.
    /// </summary>
    /// <returns>The average of the sequence of values.</returns>
    /// <param name="source">A sequence of values to calculate the average of.</param>
        ...
        Expression<Func<TSource, float>> selector)
    {
        ...
        return source.Provider.Execute<float>(Expression.Call(null, GetMethodInfo(Average, source, selector),
            new Expression[2]
            {
                source.Expression,
                Expression.Quote(selector)
    ...
    /// <summary>
    ///     Computes the average of a sequence of nullable <see cref="T:System.Single" /> values that is obtained by
    ///     invoking a projection function on each element of the input sequence.
    /// </summary>
    /// <returns>
    ///     The average of the sequence of values, or null if the <paramref name="source" /> sequence is empty or contains
    ...
    /// <summary>
    ///     Computes the average of a sequence of <see cref="T:System.Int64" /> values that is obtained by invoking a
    ///     projection function on each element of the input sequence.
    /// </summary>
    /// <returns>The average of the sequence of values.</returns>
    /// <param name="source">A sequence of values to calculate the average of.</param>
    ...
    /// <summary>
    ///     Computes the average of a sequence of nullable <see cref="T:System.Int64" /> values that is obtained by
    ///     invoking a projection function on each element of the input sequence.
    /// </summary>
    /// <returns>
    ///     The average of the sequence of values, or null if the <paramref name="source" /> sequence is empty or contains
    ...
    /// <summary>
    ///     Computes the average of a sequence of <see cref="T:System.Double" /> values that is obtained by invoking a
    ///     projection function on each element of the input sequence.
    /// </summary>
    /// <returns>The average of the sequence of values.</returns>
    /// <param name="source">A sequence of values to calculate the average of.</param>
    ...
    /// <summary>
    ///     Computes the average of a sequence of nullable <see cref="T:System.Double" /> values that is obtained by
    ///     invoking a projection function on each element of the input sequence.
    /// </summary>
    /// <returns>
    ///     The average of the sequence of values, or null if the <paramref name="source" /> sequence is empty or contains
    ...
    /// <summary>
    ///     Computes the average of a sequence of <see cref="T:System.Decimal" /> values that is obtained by invoking a
    ///     projection function on each element of the input sequence.
    /// </summary>
    /// <returns>The average of the sequence of values.</returns>
        ...
        Expression<Func<TSource, decimal>> selector)
    {
        ...
        return source.Provider.Execute<decimal>(Expression.Call(null, GetMethodInfo(Average, source, selector),
            new Expression[2]
            {
                source.Expression,
                Expression.Quote(selector)
    ...
    /// <summary>
    ///     Computes the average of a sequence of nullable <see cref="T:System.Decimal" /> values that is obtained by
    ///     invoking a projection function on each element of the input sequence.
    /// </summary>
    /// <returns>
    ///     The average of the sequence of values, or null if the <paramref name="source" /> sequence is empty or contains
    ...
    /// <returns>
    ///     An <see cref="T:System.Linq.IQueryable`1" /> that contains each element of the source sequence converted to
    ///     the specified type.
    /// </returns>
    ...
    public static IQueryable<TResult> Cast<TResult>(this IQueryable source)
    {
        ...
        return source.Provider.CreateQuery<TResult>(Expression.Call(null, GetMethodInfo(Cast<TResult>, source),
            source.Expression));
    }

    /// <summary>Concatenates two sequences.</summary>
    /// <returns>
    ///     An <see cref="T:System.Linq.IQueryable`1" /> that contains the concatenated elements of the two input
    ///     sequences.
    /// </returns>
        ...
        IEnumerable<TSource> source2)
    {
        ...
        return source1.Provider.CreateQuery<TSource>(Expression.Call(null, GetMethodInfo(Concat, source1, source2),
            new Expression[2]
            {
                source1.Expression,
    ...
    public static bool Contains<TSource>(this IQueryable<TSource> source, TSource item)
    {
        ...
        return source.Provider.Execute<bool>(Expression.Call(null, GetMethodInfo(Contains, source, item),
            new Expression[2]
            {
                source.Expression,
        ...
        IEqualityComparer<TSource> comparer)
    {
        ...
        return source.Provider.Execute<bool>(Expression.Call(null, GetMethodInfo(Contains, source, item, comparer),
            new Expression[3]
            {
                source.Expression,
                Expression.Constant(item, typeof(TSource)),
        ...
        Expression<Func<TSource, bool>> predicate)
    {
        ...
        return source.Provider.Execute<int>(Expression.Call(null, GetMethodInfo(Count, source, predicate),
            new Expression[2]
            {
                source.Expression,
                Expression.Quote(predicate)
    ...
    /// </summary>
    /// <returns>
    ///     An <see cref="T:System.Linq.IQueryable`1" /> that contains default(<paramref name="TSource" />) if
    ...
    public static IQueryable<TSource> DefaultIfEmpty<TSource>(this IQueryable<TSource> source)
    {
        ...
        return source.Provider.CreateQuery<TSource>(Expression.Call(null, GetMethodInfo(DefaultIfEmpty, source),
            source.Expression));
    }
    ...
    /// </summary>
    /// <returns>
    ///     An <see cref="T:System.Linq.IQueryable`1" /> that contains <paramref name="defaultValue" /> if
    ///     <paramref name="source" /> is empty; otherwise, <paramref name="source" />.
    /// </returns>
        ...
        TSource defaultValue)
    {
        ...
        return source.Provider.CreateQuery<TSource>(Expression.Call(null,
            GetMethodInfo(DefaultIfEmpty, source, defaultValue), new Expression[2]
            {
                source.Expression,
    ...
    public static IQueryable<TSource> Distinct<TSource>(this IQueryable<TSource> source)
    {
        ...
        return source.Provider.CreateQuery<TSource>(Expression.Call(null, GetMethodInfo(Distinct, source),
            source.Expression));
    }
        ...
        IEqualityComparer<TSource> comparer)
    {
        ...
        return source.Provider.CreateQuery<TSource>(Expression.Call(null, GetMethodInfo(Distinct, source, comparer),
            new Expression[2]
            {
                source.Expression,
                Expression.Constant(comparer, typeof(IEqualityComparer<TSource>))
    ...
    public static TSource ElementAt<TSource>(this IQueryable<TSource> source, int index)
    {
        ...
        return source.Provider.Execute<TSource>(Expression.Call(null, GetMethodInfo(ElementAt, source, index),
            new Expression[2]
            {
                source.Expression,
    ...
    /// <returns>
    ///     default(<paramref name="TSource" />) if <paramref name="index" /> is outside the bounds of
    ...
    public static TSource ElementAtOrDefault<TSource>(this IQueryable<TSource> source, int index)
    {
        ...
        return source.Provider.Execute<TSource>(Expression.Call(null, GetMethodInfo(ElementAtOrDefault, source, index),
            new Expression[2]
            {
                source.Expression,
                Expression.Constant(index)
    ...
    /// <param name="source1">
    ///     An <see cref="T:System.Linq.IQueryable`1" /> whose elements that are not also in
    ///     <paramref name="source2" /> will be returned.
    /// </param>
    /// <param name="source2">
    ///     An <see cref="T:System.Collections.Generic.IEnumerable`1" /> whose elements that also occur in
    ///     the first sequence will not appear in the returned sequence.
    /// </param>
    /// <typeparam name="TSource">The type of the elements of the input sequences.</typeparam>
    /// <exception cref="T:System.ArgumentNullException">
    ///     <paramref name="source1" /> or <paramref name="source2" /> is null.
        ...
        IEnumerable<TSource> source2)
    {
        ...
        return source1.Provider.CreateQuery<TSource>(Expression.Call(null, GetMethodInfo(Except, source1, source2),
            new Expression[2]
            {
                source1.Expression,
                GetSourceExpression(source2)
        ...
        IEqualityComparer<TSource> comparer)
    {
        ...
        return source1.Provider.CreateQuery<TSource>(Expression.Call(null,
            GetMethodInfo(Except, source1, source2, comparer), new Expression[3]
            {
                source1.Expression,
                GetSourceExpression(source2),
                Expression.Constant(comparer, typeof(IEqualityComparer<TSource>))
        ...
        Expression<Func<TSource, bool>> predicate)
    {
        ...
        return source.Provider.Execute<TSource>(Expression.Call(null, GetMethodInfo(First, source, predicate),
            new Expression[2]
            {
                source.Expression,
                Expression.Quote(predicate)
    ...
    public static TSource FirstOrDefault<TSource>(this IQueryable<TSource> source)
    {
        ...
        return source.Provider.Execute<TSource>(Expression.Call(null, GetMethodInfo(FirstOrDefault, source),
            source.Expression));
    }

    /// <summary>
    ///     Returns the first element of a sequence that satisfies a specified condition or a default value if no such
    ///     element is found.
    /// </summary>
    /// <returns>
        ...
        Expression<Func<TSource, bool>> predicate)
    {
        ...
        return source.Provider.Execute<TSource>(Expression.Call(null, GetMethodInfo(FirstOrDefault, source, predicate),
            new Expression[2]
            {
                source.Expression,
                Expression.Quote(predicate)
    ...
    /// <returns>
    ///     An IQueryable&lt;IGrouping&lt;TKey, TSource&gt;&gt; in C# or IQueryable(Of IGrouping(Of TKey, TSource)) in
        ...
        Expression<Func<TSource, TKey>> keySelector)
    {
        ...
        return source.Provider.CreateQuery<IGrouping<TKey, TSource>>(Expression.Call(null,
            GetMethodInfo(GroupBy, source, keySelector), new Expression[2]
            {
                source.Expression,
    ...
    /// </summary>
    /// <returns>
    ///     An IQueryable&lt;IGrouping&lt;TKey, TElement&gt;&gt; in C# or IQueryable(Of IGrouping(Of TKey, TElement)) in
    ///     Visual Basic where each <see cref="T:System.Linq.IGrouping`2" /> contains a sequence of objects of type
        ...
        Expression<Func<TSource, TElement>> elementSelector)
    {
        ...
        return source.Provider.CreateQuery<IGrouping<TKey, TElement>>(Expression.Call(null,
            GetMethodInfo(GroupBy, source, keySelector, elementSelector), new Expression[3]
            {
                source.Expression,
                Expression.Quote(keySelector),
    ...
    /// <returns>
    ///     An IQueryable&lt;IGrouping&lt;TKey, TSource&gt;&gt; in C# or IQueryable(Of IGrouping(Of TKey, TSource)) in
    ///     Visual Basic where each <see cref="T:System.Linq.IGrouping`2" /> contains a sequence of objects and a key.
    /// </returns>
    /// <param name="source">An <see cref="T:System.Linq.IQueryable`1" /> whose elements to group.</param>
    /// <param name="keySelector">A function to extract the key for each element.</param>
        ...
        IEqualityComparer<TKey> comparer)
    {
        ...
        return source.Provider.CreateQuery<IGrouping<TKey, TSource>>(Expression.Call(null,
            GetMethodInfo(GroupBy, source, keySelector, comparer), new Expression[3]
            {
                source.Expression,
                Expression.Quote(keySelector),
    ...
    /// <typeparam name="TElement">The type of the elements in each <see cref="T:System.Linq.IGrouping`2" />.</typeparam>
    /// <exception cref="T:System.ArgumentNullException">
    ///     <paramref name="source" /> or <paramref name="keySelector" /> or <paramref name="elementSelector" /> or
        ...
        IEqualityComparer<TKey> comparer)
    {
        ...
        return source.Provider.CreateQuery<IGrouping<TKey, TElement>>(Expression.Call(null,
            GetMethodInfo(GroupBy, source, keySelector, elementSelector, comparer), source.Expression,
    ...
    /// </summary>
    /// <returns>
    ///     An T:System.Linq.IQueryable`1 that has a type argument of <paramref name="TResult" /> and where each element
        ...
        Expression<Func<TKey, IEnumerable<TElement>, TResult>> resultSelector)
    {
        ...
        return source.Provider.CreateQuery<TResult>(Expression.Call(null,
            GetMethodInfo(GroupBy, source, keySelector, elementSelector, resultSelector), source.Expression,
        ...
        Expression<Func<TKey, IEnumerable<TSource>, TResult>> resultSelector)
    {
        ...
        return source.Provider.CreateQuery<TResult>(Expression.Call(null,
            GetMethodInfo(GroupBy, source, keySelector, resultSelector), new Expression[3]
            {
                source.Expression,
                Expression.Quote(keySelector),
    ...
    /// <summary>
    ///     Groups the elements of a sequence according to a specified key selector function and creates a result value
    ///     from each group and its key. Keys are compared by using a specified comparer.
    /// </summary>
    /// <returns>
    ///     An T:System.Linq.IQueryable`1 that has a type argument of <paramref name="TResult" /> and where each element
    ///     represents a projection over a group and its key.
    ...
    /// <typeparam name="TResult">The type of the result value returned by <paramref name="resultSelector" />.</typeparam>
    /// <exception cref="T:System.ArgumentNullException">
    ///     <paramref name="source" /> or <paramref name="keySelector" /> or <paramref name="resultSelector" /> or
    ///     <paramref name="comparer" /> is null.
    /// </exception>
    public static IQueryable<TResult> GroupBy<TSource, TKey, TResult>(
        this IQueryable<TSource> source,
        ...
        IEqualityComparer<TKey> comparer)
    {
        ...
        return source.Provider.CreateQuery<TResult>(Expression.Call(null,
            GetMethodInfo(GroupBy, source, keySelector, resultSelector, comparer), source.Expression,
    ...
    /// <summary>
    ///     Groups the elements of a sequence according to a specified key selector function and creates a result value
    ///     from each group and its key. Keys are compared by using a specified comparer and the elements of each group are
    ...
    /// <exception cref="T:System.ArgumentNullException">
    ///     <paramref name="source" /> or <paramref name="keySelector" /> or <paramref name="elementSelector" /> or
    ///     <paramref name="resultSelector" /> or <paramref name="comparer" /> is null.
    /// </exception>
    public static IQueryable<TResult> GroupBy<TSource, TKey, TElement, TResult>(
        this IQueryable<TSource> source,
        Expression<Func<TSource, TKey>> keySelector,
        ...
        IEqualityComparer<TKey> comparer)
    {
        ...
        return source.Provider.CreateQuery<TResult>(Expression.Call(null,
            GetMethodInfo(GroupBy, source, keySelector, elementSelector, resultSelector, comparer), source.Expression,
            Expression.Quote(keySelector), Expression.Quote(elementSelector), Expression.Quote(resultSelector),
            Expression.Constant(comparer, typeof(IEqualityComparer<TKey>))));
    }
    ...
    /// </summary>
    /// <returns>
    ///     An <see cref="T:System.Linq.IQueryable`1" /> that contains elements of type <paramref name="TResult" />
        ...
        Expression<Func<TOuter, IEnumerable<TInner>, TResult>> resultSelector)
    {
        ...
        return outer.Provider.CreateQuery<TResult>(Expression.Call(null,
            GetMethodInfo(GroupJoin, outer, inner, outerKeySelector, innerKeySelector, resultSelector),
            outer.Expression, GetSourceExpression(inner), Expression.Quote(outerKeySelector),
        ...
        IEqualityComparer<TKey> comparer)
    {
        ...
        return outer.Provider.CreateQuery<TResult>(Expression.Call(null,
            GetMethodInfo(GroupJoin, outer, inner, outerKeySelector, innerKeySelector, resultSelector, comparer),
            outer.Expression, GetSourceExpression(inner), Expression.Quote(outerKeySelector),
            Expression.Quote(innerKeySelector), Expression.Quote(resultSelector),
            Expression.Constant(comparer, typeof(IEqualityComparer<TKey>))));
    }
        ...
        IEnumerable<TSource> source2)
    {
        ...
        return source1.Provider.CreateQuery<TSource>(Expression.Call(null, GetMethodInfo(Intersect, source1, source2),
            new Expression[2]
            {
                source1.Expression,
                GetSourceExpression(source2)
    ...
    /// <param name="source1">
    ///     An <see cref="T:System.Linq.IQueryable`1" /> whose distinct elements that also appear in
    ...
    ///     appear in the first sequence are returned.
    /// </param>
    /// <param name="comparer">An <see cref="T:System.Collections.Generic.IEqualityComparer`1" /> to compare values.</param>
    /// <typeparam name="TSource">The type of the elements of the input sequences.</typeparam>
    /// <exception cref="T:System.ArgumentNullException">
        ...
        IEqualityComparer<TSource> comparer)
    {
        ...
        return source1.Provider.CreateQuery<TSource>(Expression.Call(null,
            GetMethodInfo(Intersect, source1, source2, comparer), new Expression[3]
            {
                source1.Expression,
                GetSourceExpression(source2),
                Expression.Constant(comparer, typeof(IEqualityComparer<TSource>))
    ...
    /// </summary>
    /// <returns>
    ///     An <see cref="T:System.Linq.IQueryable`1" /> that has elements of type <paramref name="TResult" /> obtained by
        ...
        Expression<Func<TOuter, TInner, TResult>> resultSelector)
    {
        ...
        return outer.Provider.CreateQuery<TResult>(Expression.Call(null,
            GetMethodInfo(Join, outer, inner, outerKeySelector, innerKeySelector, resultSelector), outer.Expression,
            GetSourceExpression(inner), Expression.Quote(outerKeySelector), Expression.Quote(innerKeySelector),
            Expression.Quote(resultSelector)));
    }
        ...
        IEqualityComparer<TKey> comparer)
    {
        ...
        return outer.Provider.CreateQuery<TResult>(Expression.Call(null,
            GetMethodInfo(Join, outer, inner, outerKeySelector, innerKeySelector, resultSelector, comparer),
            outer.Expression, GetSourceExpression(inner), Expression.Quote(outerKeySelector),
            Expression.Quote(innerKeySelector), Expression.Quote(resultSelector),
            Expression.Constant(comparer, typeof(IEqualityComparer<TKey>))));
    }
        ...
        Expression<Func<TSource, bool>> predicate)
    {
        ...
        return source.Provider.Execute<TSource>(Expression.Call(null, GetMethodInfo(Last, source, predicate),
            new Expression[2]
            {
                source.Expression,
                Expression.Quote(predicate)
    ...
    /// <returns>
    ///     default(<paramref name="TSource" />) if <paramref name="source" /> is empty; otherwise, the last element in
    ///     <paramref name="source" />.
    /// </returns>
    /// <param name="source">An <see cref="T:System.Linq.IQueryable`1" /> to return the last element of.</param>
    /// <typeparam name="TSource">The type of the elements of <paramref name="source" />.</typeparam>
    ...
    public static TSource LastOrDefault<TSource>(this IQueryable<TSource> source)
    {
        ...
        return source.Provider.Execute<TSource>(Expression.Call(null, GetMethodInfo(LastOrDefault, source),
            source.Expression));
    }
    ...
    /// </summary>
    /// <returns>
    ///     default(<paramref name="TSource" />) if <paramref name="source" /> is empty or if no elements pass the test in
    ///     the predicate function; otherwise, the last element of <paramref name="source" /> that passes the test in the
    ///     predicate function.
    /// </returns>
    /// <param name="source">An <see cref="T:System.Linq.IQueryable`1" /> to return an element from.</param>
    /// <param name="predicate">A function to test each element for a condition.</param>
        ...
        Expression<Func<TSource, bool>> predicate)
    {
        ...
        return source.Provider.Execute<TSource>(Expression.Call(null, GetMethodInfo(LastOrDefault, source, predicate),
            new Expression[2]
            {
                source.Expression,
                Expression.Quote(predicate)
    ...
    public static long LongCount<TSource>(this IQueryable<TSource> source)
    {
        ...
        return source.Provider.Execute<long>(Expression.Call(null, GetMethodInfo(LongCount, source),
            source.Expression));
    }

    /// <summary>
    ///     Returns an <see cref="T:System.Int64" /> that represents the number of elements in a sequence that satisfy a
    ///     condition.
    /// </summary>
        ...
        Expression<Func<TSource, bool>> predicate)
    {
        ...
        return source.Provider.Execute<long>(Expression.Call(null, GetMethodInfo(LongCount, source, predicate),
            new Expression[2]
            {
                source.Expression,
                Expression.Quote(predicate)
    ...
    /// </exception>
    /// <exception cref="T:System.InvalidOperationException">
    ///     <paramref name="source" /> does not contain any elements.
    /// </exception>
    ...
    /// <summary>
    ///     Invokes a projection function on each element of a generic <see cref="T:System.Linq.IQueryable`1" /> and
        ...
        Expression<Func<TSource, TResult>> selector)
    {
        ...
        return source.Provider.Execute<TResult>(Expression.Call(null, GetMethodInfo(Max, source, selector),
            new Expression[2]
            {
                source.Expression,
                Expression.Quote(selector)
        ...
        Expression<Func<TSource, TResult>> selector)
    {
        ...
        return source.Provider.Execute<TResult>(Expression.Call(null, GetMethodInfo(Min, source, selector),
            new Expression[2]
            {
                source.Expression,
                Expression.Quote(selector)
    ...
    /// <returns>
    ///     A collection that contains the elements from <paramref name="source" /> that have type
    ///     <paramref name="TResult" />.
    /// </returns>
    ...
    public static IQueryable<TResult> OfType<TResult>(this IQueryable source)
    {
        ...
        return source.Provider.CreateQuery<TResult>(Expression.Call(null, GetMethodInfo(OfType<TResult>, source),
            source.Expression));
    }
        ...
        Expression<Func<TSource, TKey>> keySelector)
    {
        ...
        return (IOrderedQueryable<TSource>)source.Provider.CreateQuery<TSource>(Expression.Call(null,
            GetMethodInfo(OrderBy, source, keySelector), new Expression[2]
            {
                source.Expression,
                Expression.Quote(keySelector)
            }));
        ...
        IComparer<TKey> comparer)
    {
        ...
        return (IOrderedQueryable<TSource>)source.Provider.CreateQuery<TSource>(Expression.Call(null,
            GetMethodInfo(OrderBy, source, keySelector, comparer), new Expression[3]
            {
                source.Expression,
                Expression.Quote(keySelector),
    ...
    /// <returns>
    ///     An <see cref="T:System.Linq.IOrderedQueryable`1" /> whose elements are sorted in descending order according to
    ///     a key.
    /// </returns>
    /// <param name="source">A sequence of values to order.</param>
    /// <param name="keySelector">A function to extract a key from an element.</param>
        ...
        Expression<Func<TSource, TKey>> keySelector)
    {
        ...
        return (IOrderedQueryable<TSource>)source.Provider.CreateQuery<TSource>(Expression.Call(null,
            GetMethodInfo(OrderByDescending, source, keySelector), new Expression[2]
            {
                source.Expression,
                Expression.Quote(keySelector)
            }));
        ...
        IComparer<TKey> comparer)
    {
        ...
        return (IOrderedQueryable<TSource>)source.Provider.CreateQuery<TSource>(Expression.Call(null,
            GetMethodInfo(OrderByDescending, source, keySelector, comparer), new Expression[3]
            {
                source.Expression,
                Expression.Quote(keySelector),
                Expression.Constant(comparer, typeof(IComparer<TKey>))
    ...
    /// <returns>
    ///     An <see cref="T:System.Linq.IQueryable`1" /> whose elements correspond to those of the input sequence in
    ///     reverse order.
    /// </returns>
    ...
    public static IQueryable<TSource> Reverse<TSource>(this IQueryable<TSource> source)
    {
        ...
        return source.Provider.CreateQuery<TSource>(Expression.Call(null, GetMethodInfo(Reverse, source),
            source.Expression));
    }

    /// <summary>Projects each element of a sequence into a new form.</summary>
    /// <returns>
    ///     An <see cref="T:System.Linq.IQueryable`1" /> whose elements are the result of invoking a projection function
        ...
        Expression<Func<TSource, TResult>> selector)
    {
        ...
        return source.Provider.CreateQuery<TResult>(Expression.Call(null, GetMethodInfo(Select, source, selector),
            new Expression[2]
            {
                source.Expression,
                Expression.Quote(selector)
    ...
    ///     combines the resulting sequences into one sequence.
    /// </summary>
    /// <returns>
    ///     An <see cref="T:System.Linq.IQueryable`1" /> whose elements are the result of invoking a one-to-many
    ///     projection function on each element of the input sequence.
    /// </returns>
    /// <param name="source">A sequence of values to project.</param>
    /// <param name="selector">A projection function to apply to each element.</param>
        ...
        Expression<Func<TSource, IEnumerable<TResult>>> selector)
    {
        ...
        return source.Provider.CreateQuery<TResult>(Expression.Call(null, GetMethodInfo(SelectMany, source, selector),
            new Expression[2]
            {
                source.Expression,
                Expression.Quote(selector)
    ...
    /// <summary>
    ///     Projects each element of a sequence to an <see cref="T:System.Collections.Generic.IEnumerable`1" /> and
    ///     combines the resulting sequences into one sequence. The index of each source element is used in the projected form
    ///     of that element.
    /// </summary>
    /// <returns>
    ///     An <see cref="T:System.Linq.IQueryable`1" /> whose elements are the result of invoking a one-to-many
    ...
    /// <param name="source">A sequence of values to project.</param>
    /// <param name="selector">
    ///     A projection function to apply to each element; the second parameter of this function represents
    ...
    /// <summary>
    ///     Projects each element of a sequence to an <see cref="T:System.Collections.Generic.IEnumerable`1" /> that
    ///     incorporates the index of the source element that produced it. A result selector function is invoked on each
    ///     element of each intermediate sequence, and the resulting values are combined into a single, one-dimensional
    ///     sequence and returned.
    /// </summary>
    /// <returns>
    ///     An <see cref="T:System.Linq.IQueryable`1" /> whose elements are the result of invoking the one-to-many
    ///     projection function <paramref name="collectionSelector" /> on each element of <paramref name="source" /> and then
    ///     mapping each of those sequence elements and their corresponding <paramref name="source" /> element to a result
    ///     element.
    /// </returns>
    /// <param name="source">A sequence of values to project.</param>
        ...
        Expression<Func<TSource, TCollection, TResult>> resultSelector)
    {
        ...
        return source.Provider.CreateQuery<TResult>(Expression.Call(null,
            GetMethodInfo(SelectMany, source, collectionSelector, resultSelector), new Expression[3]
            {
                source.Expression,
    ...
    /// <summary>
    ///     Projects each element of a sequence to an <see cref="T:System.Collections.Generic.IEnumerable`1" /> and
    ///     invokes a result selector function on each element therein. The resulting values from each intermediate sequence
    ///     are combined into a single, one-dimensional sequence and returned.
    /// </summary>
    /// <returns>
    ///     An <see cref="T:System.Linq.IQueryable`1" /> whose elements are the result of invoking the one-to-many
    ///     projection function <paramref name="collectionSelector" /> on each element of <paramref name="source" /> and then
    ...
    /// <returns>
    ///     true if the two source sequences are of equal length and their corresponding elements compare equal;
    ///     otherwise, false.
    /// </returns>
    /// <param name="source1">
    ///     An <see cref="T:System.Linq.IQueryable`1" /> whose elements to compare to those of
    ///     <paramref name="source2" />.
    /// </param>
    /// <param name="source2">
    ///     An <see cref="T:System.Collections.Generic.IEnumerable`1" /> whose elements to compare to those
        ...
        IEnumerable<TSource> source2)
    {
        ...
        return source1.Provider.Execute<bool>(Expression.Call(null, GetMethodInfo(SequenceEqual, source1, source2),
            new Expression[2]
            {
                source1.Expression,
                GetSourceExpression(source2)
    ...
    ///     <see cref="T:System.Collections.Generic.IEqualityComparer`1" /> to compare elements.
    /// </summary>
    /// <returns>
    ///     true if the two source sequences are of equal length and their corresponding elements compare equal;
    ///     otherwise, false.
        ...
        IEqualityComparer<TSource> comparer)
    {
        ...
        return source1.Provider.Execute<bool>(Expression.Call(null,
            GetMethodInfo(SequenceEqual, source1, source2, comparer), new Expression[3]
            {
                source1.Expression,
                GetSourceExpression(source2),
                Expression.Constant(comparer, typeof(IEqualityComparer<TSource>))
    ...
    public static TSource Single<TSource>(this IQueryable<TSource> source)
    {
        ...
        return source.Provider.Execute<TSource>(Expression.Call(null, GetMethodInfo(Single, source),
            source.Expression));
    }
        ...
        Expression<Func<TSource, bool>> predicate)
    {
        ...
        return source.Provider.Execute<TSource>(Expression.Call(null, GetMethodInfo(Single, source, predicate),
            new Expression[2]
            {
                source.Expression,
                Expression.Quote(predicate)
    ...
    public static TSource SingleOrDefault<TSource>(this IQueryable<TSource> source)
    {
        ...
        return source.Provider.Execute<TSource>(Expression.Call(null, GetMethodInfo(SingleOrDefault, source),
            source.Expression));
    }
    ...
    /// </summary>
    /// <returns>
    ///     The single element of the input sequence that satisfies the condition in <paramref name="predicate" />, or
    ///     default(<paramref name="TSource" />) if no such element is found.
    /// </returns>
    /// <param name="source">An <see cref="T:System.Linq.IQueryable`1" /> to return a single element from.</param>
    /// <param name="predicate">A function to test an element for a condition.</param>
    /// <typeparam name="TSource">The type of the elements of <paramref name="source" />.</typeparam>
        ...
        Expression<Func<TSource, bool>> predicate)
    {
        ...
        return source.Provider.Execute<TSource>(Expression.Call(null, GetMethodInfo(SingleOrDefault, source, predicate),
            new Expression[2]
            {
                source.Expression,
                Expression.Quote(predicate)
    ...
    /// <returns>
    ///     An <see cref="T:System.Linq.IQueryable`1" /> that contains elements that occur after the specified index in
    ///     the input sequence.
    /// </returns>
    ...
    public static IQueryable<TSource> Skip<TSource>(this IQueryable<TSource> source, int count)
    {
        ...
        return source.Provider.CreateQuery<TSource>(Expression.Call(null, GetMethodInfo(Skip, source, count),
            new Expression[2]
            {
                source.Expression,
    ...
    /// </summary>
    /// <returns>
    ///     An <see cref="T:System.Linq.IQueryable`1" /> that contains elements from <paramref name="source" /> starting
    ///     at the first element in the linear series that does not pass the test specified by <paramref name="predicate" />.
    /// </returns>
    /// <param name="source">An <see cref="T:System.Linq.IQueryable`1" /> to return elements from.</param>
    /// <param name="predicate">A function to test each element for a condition.</param>
    /// <typeparam name="TSource">The type of the elements of <paramref name="source" />.</typeparam>
        ...
        Expression<Func<TSource, bool>> predicate)
    {
        ...
        return source.Provider.CreateQuery<TSource>(Expression.Call(null, GetMethodInfo(SkipWhile, source, predicate),
            new Expression[2]
            {
                source.Expression,
                Expression.Quote(predicate)
    ...
    /// <summary>
    ///     Computes the sum of the sequence of <see cref="T:System.Int32" /> values that is obtained by invoking a
    ///     projection function on each element of the input sequence.
    /// </summary>
        ...
        Expression<Func<TSource, int>> selector)
    {
        ...
        return source.Provider.Execute<int>(Expression.Call(null, GetMethodInfo(Sum, source, selector),
            new Expression[2]
            {
                source.Expression,
                Expression.Quote(selector)
    ...
    /// <summary>
    ///     Computes the sum of the sequence of nullable <see cref="T:System.Int32" /> values that is obtained by invoking
    ///     a projection function on each element of the input sequence.
    /// </summary>
    /// <returns>The sum of the projected values.</returns>
    /// <param name="source">A sequence of values of type <paramref name="TSource" />.</param>
    /// <param name="selector">A projection function to apply to each element.</param>
    ...
    /// <summary>
    ///     Computes the sum of the sequence of <see cref="T:System.Int64" /> values that is obtained by invoking a
    ///     projection function on each element of the input sequence.
    /// </summary>
    /// <returns>The sum of the projected values.</returns>
    /// <param name="source">A sequence of values of type <paramref name="TSource" />.</param>
        ...
        Expression<Func<TSource, long>> selector)
    {
        ...
        return source.Provider.Execute<long>(Expression.Call(null, GetMethodInfo(Sum, source, selector),
            new Expression[2]
            {
                source.Expression,
                Expression.Quote(selector)
    ...
    /// <summary>
    ///     Computes the sum of the sequence of nullable <see cref="T:System.Int64" /> values that is obtained by invoking
    ///     a projection function on each element of the input sequence.
    /// </summary>
    /// <returns>The sum of the projected values.</returns>
    /// <param name="source">A sequence of values of type <paramref name="TSource" />.</param>
    ...
    /// <summary>
    ///     Computes the sum of the sequence of <see cref="T:System.Single" /> values that is obtained by invoking a
    ///     projection function on each element of the input sequence.
    /// </summary>
    /// <returns>The sum of the projected values.</returns>
    /// <param name="source">A sequence of values of type <paramref name="TSource" />.</param>
        ...
        Expression<Func<TSource, float>> selector)
    {
        ...
        return source.Provider.Execute<float>(Expression.Call(null, GetMethodInfo(Sum, source, selector),
            new Expression[2]
            {
                source.Expression,
                Expression.Quote(selector)
    ...
    /// <summary>
    ///     Computes the sum of the sequence of nullable <see cref="T:System.Single" /> values that is obtained by
    ///     invoking a projection function on each element of the input sequence.
    /// </summary>
    /// <returns>The sum of the projected values.</returns>
    /// <param name="source">A sequence of values of type <paramref name="TSource" />.</param>
    ...
    /// <summary>
    ///     Computes the sum of the sequence of <see cref="T:System.Double" /> values that is obtained by invoking a
    ///     projection function on each element of the input sequence.
    /// </summary>
    /// <returns>The sum of the projected values.</returns>
    /// <param name="source">A sequence of values of type <paramref name="TSource" />.</param>
        ...
        Expression<Func<TSource, double>> selector)
    {
        ...
        return source.Provider.Execute<double>(Expression.Call(null, GetMethodInfo(Sum, source, selector),
            new Expression[2]
            {
                source.Expression,
                Expression.Quote(selector)
    ...
    /// <summary>
    ///     Computes the sum of the sequence of nullable <see cref="T:System.Double" /> values that is obtained by
    ///     invoking a projection function on each element of the input sequence.
    /// </summary>
    /// <returns>The sum of the projected values.</returns>
    /// <param name="source">A sequence of values of type <paramref name="TSource" />.</param>
    ...
    /// <summary>
    ///     Computes the sum of the sequence of <see cref="T:System.Decimal" /> values that is obtained by invoking a
    ///     projection function on each element of the input sequence.
    /// </summary>
    /// <returns>The sum of the projected values.</returns>
    /// <param name="source">A sequence of values of type <paramref name="TSource" />.</param>
        ...
        Expression<Func<TSource, decimal>> selector)
    {
        ...
        return source.Provider.Execute<decimal>(Expression.Call(null, GetMethodInfo(Sum, source, selector),
            new Expression[2]
            {
                source.Expression,
                Expression.Quote(selector)
    ...
    /// <summary>
    ///     Computes the sum of the sequence of nullable <see cref="T:System.Decimal" /> values that is obtained by
    ///     invoking a projection function on each element of the input sequence.
    /// </summary>
    /// <returns>The sum of the projected values.</returns>
    /// <param name="source">A sequence of values of type <paramref name="TSource" />.</param>
    ...
    /// <returns>
    ///     An <see cref="T:System.Linq.IQueryable`1" /> that contains the specified number of elements from the start of
    ///     <paramref name="source" />.
    /// </returns>
    ...
    public static IQueryable<TSource> Take<TSource>(this IQueryable<TSource> source, int count)
    {
        ...
        return source.Provider.CreateQuery<TSource>(Expression.Call(null, GetMethodInfo(Take, source, count),
            new Expression[2]
            {
                source.Expression,
                Expression.Constant(count)
    ...
    /// <returns>
    ///     An <see cref="T:System.Linq.IQueryable`1" /> that contains elements from the input sequence occurring before
    ///     the element at which the test specified by <paramref name="predicate" /> no longer passes.
    /// </returns>
    /// <param name="source">The sequence to return elements from.</param>
    /// <param name="predicate">A function to test each element for a condition.</param>
    /// <typeparam name="TSource">The type of the elements of <paramref name="source" />.</typeparam>
        ...
        Expression<Func<TSource, bool>> predicate)
    {
        ...
        return source.Provider.CreateQuery<TSource>(Expression.Call(null, GetMethodInfo(TakeWhile, source, predicate),
            new Expression[2]
            {
                source.Expression,
                Expression.Quote(predicate)
        ...
        Expression<Func<TSource, TKey>> keySelector)
    {
        ...
        return (IOrderedQueryable<TSource>)source.Provider.CreateQuery<TSource>(Expression.Call(null,
            GetMethodInfo(ThenBy, source, keySelector), new Expression[2]
            {
                source.Expression,
                Expression.Quote(keySelector)
            }));
        ...
        IComparer<TKey> comparer)
    {
        ...
        return (IOrderedQueryable<TSource>)source.Provider.CreateQuery<TSource>(Expression.Call(null,
            GetMethodInfo(ThenBy, source, keySelector, comparer), new Expression[3]
            {
                source.Expression,
                Expression.Quote(keySelector),
                Expression.Constant(comparer, typeof(IComparer<TKey>))
        ...
        Expression<Func<TSource, TKey>> keySelector)
    {
        ...
        return (IOrderedQueryable<TSource>)source.Provider.CreateQuery<TSource>(Expression.Call(null,
            GetMethodInfo(ThenByDescending, source, keySelector), new Expression[2]
            {
                source.Expression,
                Expression.Quote(keySelector)
            }));
        ...
        IComparer<TKey> comparer)
    {
        ...
        return (IOrderedQueryable<TSource>)source.Provider.CreateQuery<TSource>(Expression.Call(null,
            GetMethodInfo(ThenByDescending, source, keySelector, comparer), new Expression[3]
            {
                source.Expression,
                Expression.Quote(keySelector),
                Expression.Constant(comparer, typeof(IComparer<TKey>))
    ...
    /// <returns>
    ///     An <see cref="T:System.Linq.IQueryable`1" /> that contains the elements from both input sequences, excluding
    ///     duplicates.
    /// </returns>
        ...
        IEnumerable<TSource> source2)
    {
        ...
        return source1.Provider.CreateQuery<TSource>(Expression.Call(null, GetMethodInfo(Union, source1, source2),
            new Expression[2]
            {
                source1.Expression,
                GetSourceExpression(source2)
        ...
        IEqualityComparer<TSource> comparer)
    {
        ...
        return source1.Provider.CreateQuery<TSource>(Expression.Call(null,
            GetMethodInfo(Union, source1, source2, comparer), new Expression[3]
            {
                source1.Expression,
                GetSourceExpression(source2),
                Expression.Constant(comparer, typeof(IEqualityComparer<TSource>))
        ...
        Expression<Func<TSource, bool>> predicate)
    {
        ...
        return source.Provider.CreateQuery<TSource>(Expression.Call(null, GetMethodInfo(Where, source, predicate),
            new Expression[2]
            {
                source.Expression,
                Expression.Quote(predicate)
        ...
        Expression<Func<TFirst, TSecond, TResult>> resultSelector)
    {
        ...
        return source1.Provider.CreateQuery<TResult>(Expression.Call(null,
            GetMethodInfo(Zip, source1, source2, resultSelector), new Expression[3]
            {
                source1.Expression,
                GetSourceExpression(source2),
                Expression.Quote(resultSelector)
    ...
    {
        return source is IQueryable<TSource> queryable
