...
///     The type of the elements of each <see cref="T:System.Collections.Generic.IEnumerable`1" />
    ...
    ILookup<TKey, TElement>
{
    ...
    /// <summary>
    ///     Returns an enumerator that iterates through the <see cref="T:System.Linq.Lookup`2" />. This class cannot be
    ///     inherited.
    /// </summary>
    /// <returns>An enumerator for the <see cref="T:System.Linq.Lookup`2" />.</returns>
    ...
    public IEnumerable<TElement> this[TKey key] =>
        (IEnumerable<TElement>)GetGrouping(key, false) ?? EmptyEnumerable<TElement>.Instance;
    ...
    ///     <see cref="T:System.Linq.Lookup`2" />.
    /// </returns>
    ...
    internal static Lookup<TKey, TElement> CreateForJoin(
        ...
        IEqualityComparer<TKey> comparer)
    {
        var forJoin = new Lookup<TKey, TElement>(comparer);
    ...
    internal Grouping GetGrouping(TKey key, bool create)
    {
        ...
        grouping1.hashNext = groupings[index];
    ...
    {
        return key != null ? comparer.GetHashCode(key) & int.MaxValue : 0;
    }
