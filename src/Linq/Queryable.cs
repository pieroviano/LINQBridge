...
public static class Queryable
{
    ...
    private static Expression GetSourceExpression<TSource>(IEnumerable<TSource> source) => source is IQueryable<TSource> queryable ? queryable.Expression : Expression.Constant(source, typeof(IEnumerable<TSource>));
        ...
        Expression<Func<TOuter, TInner, TResult>> resultSelector)
    {
        ...
        if (resultSelector == null)
            throw Error.ArgumentNull(nameof(resultSelector));
        return outer.Provider.CreateQuery<TResult>(Expression.Call(null, ((MethodInfo)MethodBase.GetCurrentMethod()).MakeGenericMethod(typeof(TOuter), typeof(TInner), typeof(TKey), typeof(TResult)), outer.Expression, GetSourceExpression<TInner>(inner), Expression.Quote(outerKeySelector), Expression.Quote(innerKeySelector), Expression.Quote(resultSelector)));
    }
        ...
        IEqualityComparer<TKey> comparer)
    {
        ...
        if (resultSelector == null)
            throw Error.ArgumentNull(nameof(resultSelector));
        return outer.Provider.CreateQuery<TResult>(Expression.Call(null, ((MethodInfo)MethodBase.GetCurrentMethod()).MakeGenericMethod(typeof(TOuter), typeof(TInner), typeof(TKey), typeof(TResult)), outer.Expression, GetSourceExpression<TInner>(inner), Expression.Quote(outerKeySelector), Expression.Quote(innerKeySelector), Expression.Quote(resultSelector), Expression.Constant(comparer, typeof(IEqualityComparer<TKey>))));
    }
        ...
        IEnumerable<TSource> source2)
    {
        ...
        return source1.Provider.CreateQuery<TSource>(Expression.Call(null, ((MethodInfo)MethodBase.GetCurrentMethod()).MakeGenericMethod(typeof(TSource)), source1.Expression, GetSourceExpression<TSource>(source2)));
    }
        ...
        IEqualityComparer<TSource> comparer)
    {
        ...
        if (source2 == null)
            throw Error.ArgumentNull(nameof(source2));
        return source1.Provider.CreateQuery<TSource>(Expression.Call(null, ((MethodInfo)MethodBase.GetCurrentMethod()).MakeGenericMethod(typeof(TSource)), source1.Expression, GetSourceExpression<TSource>(source2), Expression.Constant(comparer, typeof(IEqualityComparer<TSource>))));
    }
        ...
        IEnumerable<TSource> source2)
    {
        ...
        if (source2 == null)
            throw Error.ArgumentNull(nameof(source2));
        return source1.Provider.Execute<bool>(Expression.Call(null, ((MethodInfo)MethodBase.GetCurrentMethod()).MakeGenericMethod(typeof(TSource)), source1.Expression, GetSourceExpression<TSource>(source2)));
    }
        ...
        IEqualityComparer<TSource> comparer)
    {
        ...
        if (source2 == null)
            throw Error.ArgumentNull(nameof(source2));
        return source1.Provider.Execute<bool>(Expression.Call(null, ((MethodInfo)MethodBase.GetCurrentMethod()).MakeGenericMethod(typeof(TSource)), source1.Expression, GetSourceExpression<TSource>(source2), Expression.Constant(comparer, typeof(IEqualityComparer<TSource>))));
    }
